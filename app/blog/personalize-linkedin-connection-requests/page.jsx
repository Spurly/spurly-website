...
const SLUG = "personalize-linkedin-connection-requests";
  ...
  return (
    <BlogLayout slug={SLUG}>
      ...
      <ul>
        ...
        <li>
          <strong>Brevity.</strong> Connection notes are capped and skimmed.
      ...
      <p>
        With a tool like <Link href="/">Spurly</Link>, you capture a whole
        LinkedIn or Sales Navigator search into a Session, drop in your template
        with <code>{"{{name}}"}</code>, <code>{"{{company}}"}</code> and{" "}
