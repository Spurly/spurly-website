...
export const metadata = {
  ...
  description:
    "The terms governing your use of Spurly, the LinkedIn & Sales Navigator prospecting Chrome extension. Acceptable use, accounts, credits, and liability.",
  alternates: { canonical: "/terms" },
  openGraph: {
    title: "Terms of Service — Spurly",
    description: "The terms governing your use of Spurly.",
    url: "/terms",
  },
};
  ...
  return (
    <ContentShell>
      <article className="prose wrap">
        ...
        <p>
          Spurly is a tool; how you use it is your responsibility. You agree to:
        </p>
        <ul>
          <li>
          ...
          <li>
            Not attempt to disrupt, reverse-engineer, or abuse the service or
            its infrastructure.
          </li>
        </ul>
        <p>
        ...
        <p>
          To the maximum extent permitted by law, Spurly and its team will not
