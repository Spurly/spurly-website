...
export const metadata = {
  ...
  description:
    "Get help with Spurly. Answers to common questions about capturing leads, enrichment, pricing, privacy, and Sales Navigator — plus how to reach our team.",
  alternates: { canonical: "/support" },
  openGraph: {
    title: "Support & FAQ — Spurly",
    description: "Get help with Spurly and find answers to common questions.",
    url: "/support",
  },
};
    ...
    <ContentShell>
      ...
      <article className="prose wrap">
        ...
        <p>
          ...
          You can also read our <Link href="/privacy">Privacy Policy</Link> and{" "}
          <Link href="/terms">Terms of Service</Link>, or explore the{" "}
          <Link href="/blog">Spurly blog</Link> for outreach guides.
        </p>
      </article>
    </ContentShell>
  );
