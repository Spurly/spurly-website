...
const PLANS = [
  {
    ...
    feats: [
      { t: "100 credits / month" },
      { t: "Capture from LinkedIn & Sales Navigator" },
      { t: "Unlimited Sessions" },
      { t: "CSV export", off: true },
    ],
  },
  {
    ...
    feats: [
      ...
      { t: "Profile enrichment (email & details)" },
    ...
    <section id="pricing" className="section-pad">
      <div className="wrap">
        <div className="sec-head center reveal">
          ...
          <p className="lead">Every plan includes capture, enrichment, connect and reach-out. Credits are spent only when Spurly does work for you.</p>
        </div>
        ...
        <p className="center" style={{ marginTop: 24, color: "var(--text-3)", fontSize: 13.5 }}>Placeholder pricing — send me your real tiers and I'll drop them in.</p>
      </div>
    </section>
  );
}
